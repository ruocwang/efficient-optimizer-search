...
def pad_minibatch(minibatch, num_features=-1, pad_token=-1, return_max=False):
    # wrc: wrong? #minibatch to be of dimension [num_sequences(batch_size), num_features, len of each sequence (variable)]
    # minibatch to be of dimension [num_sequences(batch_size), seq_len (variable), num_features]
