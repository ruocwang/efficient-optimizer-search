...
def main(args, opt_func):
    ...
    # Optimizer and Scheduler and math around the number of training steps.
    ...
    optimizer = opt_func(optimizer_grouped_parameters)
    if hasattr(optimizer, 'T'):
        optimizer.T = args.max_train_steps
    ...
    score = eval_metric[args.metric_name]
    log_str = ''
    return score, score, epoch, 'finished', log_str
