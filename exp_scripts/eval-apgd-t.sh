...
if [[ $extra_configs == "none" ]]; then
    extra_configs="task=apgd-t;num_epochs_gs=1;hps={'lr':[0],'step':[100]}"
else
    extra_configs="task=apgd-t;num_epochs_gs=1;hps={'lr':[0],'step':[100]};"$extra_configs
fi
